...
extern int16_t CBOR_Pulse_byte_array_compare(size_t sz, uint8_t *a1, uint8_t *a2);

extern int16_t CBOR_Pulse_cbor_compare(cbor a1, cbor a2);

extern bool CBOR_Pulse_cbor_is_equal(cbor a1, cbor a2);
...
extern CBOR_Pulse_cbor_map_get_t CBOR_Pulse_cbor_map_get(cbor key, cbor map);

extern bool CBOR_Pulse_cbor_map_sort(cbor_map_entry *a, size_t len);
